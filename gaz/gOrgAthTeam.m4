inflect_sg( {Arsenal} | {Chelsea} | {Lions} | {Liverpool} | {Lotu} ["s"|{kse}] | {McLaren} | {NBA} | {Rochester} | {Salisbury} | {Sunderland} | {Swansea} | {Trabzonspor} | {Williams} ) |
...
wordform_exact({Buffalo}) WSep inflect_sg({Sabre} ["s"|{kse}]) |
...
wordform_exact({Espoo}) WSep inflect_sg({Blue} ["s"|{kse}]) |
wordform_exact({Espoon}) WSep inflect_sg({Blue} ["s"|{kse}]) |
...
wordform_exact({Peterborough}) WSep inflect_sg({Pete} ["s"|{kse}]) |
wordform_exact({Red}) WSep inflect_sg({Bull}) |
wordform_exact({Red}) WSep inflect_sg({Wings}) |
wordform_exact({Sahara}) WSep wordform_exact({Force}) WSep wordform_exact({India}) WSep wordform_exact({F1}) WSep inflect_sg({Team}) |
wordform_exact({Saint}) WSep wordform_exact({John}) WSep wordform_exact({Sea}) WSep inflect_sg({Dogs}) |
wordform_exact({Tampa}) WSep wordform_exact({Bay}) WSep inflect_sg({Lightning}) |
wordform_exact({Utah}) WSep inflect_sg({Jazz})
